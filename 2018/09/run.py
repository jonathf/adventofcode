...
a multiple of 23, something entirely different happens. First, the current
...
marble located immediately clockwise of the marble that was removed becomes the
new current marble.
...
def calc_scores(players: int, marbles: int):
    """
    Calculate the final score of the Marble Mania game.
...
if __name__ == "__main__":
    with open("input") as src:
        PLAYERS, MARBLES = [int(d) for d in re.findall(r"\d+", src.read())]

    print("solution part 1:", calc_scores(PLAYERS, MARBLES))
    # solution part 1: 384892
    print("solution part 2:", calc_scores(PLAYERS, 100*MARBLES))
    # solution part 2: 3169872331
